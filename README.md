...
|---|---|---|
| `ETH_RPC_URL` | `cmd/probe-uniswap`, `cmd/arbd` | Free Alchemy app on Ethereum Mainnet → "Endpoints" → HTTPS URL |
| `ETH_RPC_WS_URL` | `cmd/probe-chain`, `cmd/arbd` | Same Alchemy app → "Endpoints" → WSS URL |
